			...
			<div className="resume_wrapper" id="resume">
				...
				<div className="resume_right">
					...
					<section className="profile">
						...
						<p>
							I am full stack engineer who focused on MERN (MongoDB, Express,
							React, Node) stack.
						</p>
						<p>
							I use React framework to create beautiful web applications and
							Nodejs for meaningful APIs.
						</p>
						<p>
							I am coding for 2 years. While I code I always try creating
							reusable functions and modular approach as much as I can.
						</p>
					</section>
